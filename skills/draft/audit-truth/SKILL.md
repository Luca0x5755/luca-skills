...
6. **File the tickets.** Every verdict that demands a change becomes a tracker ticket — filed in the tracker `docs/agents/issue-tracker.md` names; none configured → ask where tickets live. A verdict without a ticket is a finding buried at the scene.
